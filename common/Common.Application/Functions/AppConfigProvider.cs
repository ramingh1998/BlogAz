...
namespace Common.Application.Functions
{
    public static class AppConfigProvider
    {
        ...
        {
            return GetConfig().smsPassword;
        }
        //===========================================================================
        public static string GetSmsSenderPhoneNumber()
        {
            return GetConfig().smsSenderPhoneNumber;
        }
        //===========================================================================
        public static string GetSepehr_MerchantId()
        {
            return GetConfig().sepehr_MerchantId;
        }
        //===========================================================================
        public static string GetSkyRoomSecretKey()
        {
            return GetConfig().skyRoomSecretKey;
        }
        ////===========================================================================
        public static string GetSmsUserName()
        {
            return GetConfig().smsUserName;
        }
        ////===========================================================================
        public static string GetAdminMobNo()
        {
            return GetConfig().adminMobNo;
        }
        //===========================================================================
        ...
        //===========================================================================
        public static string GetPayPingToken()
        {
            return GetConfig().payPingToken;
        }
        //===========================================================================
        ...
        {
            return GetConfig().onlineExamUrl;
        }
        //===========================================================================
        ...
        public static int GetSpotplayerStudentAmount()
        {
            return GetConfig().SpotplayerStudentAmount;
        }
        //===========================================================================
        ...
        //===========================================================================
        public static string GetOnlineClassLogoutUrl()
        {
            return GetConfig().onlineClassLogoutUrl;
        }

        //===========================================================================
        public static string GetBigBlueButtonSecretKey()
        {
            return GetConfig().bigBlueButtonSecretKey;
        }
        //===========================================================================
        public static string GetBigBlueButtonServerUrl()
        {
            return GetConfig().bigBlueButtonServerUrl;
        }
        //===========================================================================
        public static string GetOnlineClassPlanId()
        {
            return GetConfig().onlineClassPlanId;
        }
        //===========================================================================
        public static string GetBigBlueButtonRecordUrl()
        {
            return GetConfig().bigBlueButtonRecordUrl;
        }
        //===========================================================================
        ...
        //===========================================================================
        public static string GetSiteMainDomain()
        {
            return GetConfig().siteMainDomain;
        }
        //===========================================================================
    }
}
