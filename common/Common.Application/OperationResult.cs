namespace Common.Application
{
    ...
    {
        public const string SuccessMessage = "Əməliyyat uğurla yerinə yetirildi.";
        public const string ErrorMessage = "Əməliyyat uğursuz oldu.";
    ...
    public class OperationResult
    {
        public const string SuccessMessage = "Əməliyyat uğurla yerinə yetirildi.";
        public const string ErrorMessage = "Əməliyyat uğursuz oldu.";
        public const string NotFoundMessage = "اMəlumat tapılmadı";
        public string Message { get; set; }
        public string Title { get; set; } = null;
        public OperationResultStatus Status { get; set; }
